...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#00FFFF" style="border-collapse:collapse"> 
      <tr><td bordercolor="#00FF33">企业编号：</td>
      <td bordercolor="#00FF33"><input name='qiyebianhao' type='text' id='qiyebianhao' value='<?php echo mysql_result($query,$i,qiyebianhao);?>' readonly='readonly' /> 此项主键，不得修改</td></tr><tr><td bordercolor="#00FF33">企业名称：</td>
      <td bordercolor="#00FF33"><input name='qiyemingcheng' type='text' id='qiyemingcheng' size='50' value='<?php echo mysql_result($query,$i,qiyemingcheng);?>' /></td></tr><tr><td bordercolor="#00FF33">类别：</td>
      ...
      </tr><script language="javascript">document.form1.leibie.value='<?php echo mysql_result($query,$i,leibie);?>';</script><tr><td bordercolor="#00FF33">联系电话：</td>
      <td bordercolor="#00FF33"><input name='lianxidianhua' type='text' id='lianxidianhua' value='<?php echo mysql_result($query,$i,lianxidianhua);?>' /></td></tr><tr><td bordercolor="#00FF33">地址：</td>
      <td bordercolor="#00FF33"><input name='dizhi' type='text' id='dizhi' size='50' value='<?php echo mysql_result($query,$i,dizhi);?>' /></td></tr><tr><td bordercolor="#00FF33">负责人：</td>
      <td bordercolor="#00FF33"><input name='fuzeren' type='text' id='fuzeren' value='<?php echo mysql_result($query,$i,fuzeren);?>' /></td></tr><tr><td bordercolor="#00FF33">主营业务：</td>
      <td bordercolor="#00FF33"><input name='zhuyingyewu' type='text' id='zhuyingyewu' size='50' value='<?php echo mysql_result($query,$i,zhuyingyewu);?>' /></td></tr><tr><td bordercolor="#00FF33">门面照片：</td>
      ...
      <td bordercolor="#00FF33"><textarea name='beizhu' cols='50' rows='8' id='beizhu'><?php echo mysql_result($query,$i,beizhu);?></textarea></td></tr><tr><td bordercolor="#00FF33">密码：</td>
