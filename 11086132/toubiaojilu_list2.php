...
<form id="form1" name="form1" method="post" action="">
  搜索: 标题：<input name="biaoti" type="text" id="biaoti" size=12 style='border:solid 1px #000000; color:#666666;' /> 发布人：<input name="faburen" type="text" id="faburen" size=12 style='border:solid 1px #000000; color:#666666;' /> 投标金额：<input name="toubiaojine1" type="text" id="toubiaojine1"  value='' style='border:solid 1px #000000; color:#666666;width:30px' />-<input name="toubiaojine2" type="text" id="toubiaojine2"  value='' style='border:solid 1px #000000; color:#666666;width:30px' />
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#66FF00" style="border-collapse:collapse">  
  ...
  <?php 
    $sql="select * from toubiaojilu where toubiaoren='".$_SESSION['username']."'";
...
<p>以上数据共<?php
		echo $rowscount;
	?>条</p>
<p align="center"><a href="toubiaojilu_list2.php?pagecurrent=1">首页</a>, <a href="toubiaojilu_list2.php?pagecurrent=<?php echo $pagecurrent-1;?>">前一页</a> ,<a href="toubiaojilu_list2.php?pagecurrent=<?php echo $pagecurrent+1;?>">后一页</a>, <a href="toubiaojilu_list2.php?pagecurrent=<?php echo $pagecount;?>">末页</a>, 当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 </p>
