	...
	for($i=$pagecurrent*$pagelarge-$pagelarge;$i<$ddddd;$i++)
{
  ?>
                                  <tr height="25">
                                    ...
                                    <td width="64%" class="newsline"><a href="gg_detail.php?id=<?php echo mysql_result($query,$i,"id");?>"><font class="STYLE1"><?php echo mysql_result($query,$i,"biaoti");?></font></a></td>
                                    <td width="11%" class="newsline"><font class="STYLE1">被点击<?php echo mysql_result($query,$i,"dianjilv");?>次</font></td>
                                    <td width="22%" class="newsline"><font class="STYLE1"><?php echo mysql_result($query,$i,"addtime");?></font></td>
                                  </tr>
                                  <?php
						}
					  }
					  ?>
                                  ...
                                  <p align="center"><a href="news.php?pagecurrent=1&lb=<?php echo $lb;?>"><font class="STYLE1">首页</font></a>, <a href="news.php?pagecurrent=<?php echo $pagecurrent-1;?>&lb=<?php echo $lb;?>"><font class="STYLE1">前一页</font></a> ,<a href="news.php?pagecurrent=<?php echo $pagecurrent+1;?>&lb=<?php echo $lb;?>"><font class="STYLE1">后一页</font></a>, <a href="news.php?pagecurrent=<?php echo $pagecount;?>&lb=<?php echo $lb;?>"><font class="STYLE1">末页</font></a>, <font class="STYLE1">当前第<?php echo $pagecurrent;?>页,共<?php echo $pagecount;?>页 以上数据共
                                    <?php
		echo $rowscount;
	?>
                                    条</font></p></td>
