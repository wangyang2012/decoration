...
if ($addnew=="1" )
{
	...
	mysql_query($sql);
	echo "<script>javascript:alert('修改成功!');location.href='toubiaojilu_list.php';</script>";
}
?>
...
<body>
<p>修改投标记录： 当前日期： <?php echo $ndate; ?></p>
<?php
...
<table width="100%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#66FF00" style="border-collapse:collapse"> 
      <tr><td>标题：</td><td><input name='biaoti' type='text' id='biaoti' size='50' value='<?php echo mysql_result($query,$i,biaoti);?>' /></td></tr><tr><td>发布人：</td><td><input name='faburen' type='text' id='faburen' value='<?php echo mysql_result($query,$i,faburen);?>' /></td></tr><tr><td>预算起价：</td><td><input name='yusuanqijia' type='text' id='yusuanqijia' value='<?php echo mysql_result($query,$i,yusuanqijia);?>' /></td></tr><tr><td>投标金额：</td><td><input name='toubiaojine' type='text' id='toubiaojine' value='<?php echo mysql_result($query,$i,toubiaojine);?>' /></td></tr><tr><td>投标书内容：</td><td><textarea name="toubiaoshuneirong" style="width:700px;height:200px;visibility:hidden;"><?php echo mysql_result($query,$i,toubiaoshuneirong);?></textarea></td></tr><tr><td>附件：</td><td><input name='fujian' type='text' id='fujian' size='50'  value='<?php echo mysql_result($query,$i,fujian);?>' /> &nbsp;<a href="javaScript:OpenScript('upfile.php?Result=fujian',460,180)"><img src="Images/Upload.gif" width="30" height="16" border="0" align="absmiddle" /></a></td></tr><tr><td>投标人：</td><td><input name='toubiaoren' type='text' id='toubiaoren' value='<?php echo mysql_result($query,$i,toubiaoren);?>' /></td></tr>
    <tr>
      <td>&nbsp;</td>
